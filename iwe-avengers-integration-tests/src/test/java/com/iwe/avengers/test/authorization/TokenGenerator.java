...
public class TokenGenerator {
	...
	public String getToken() {
		...
		final String clientId = "7dqvdoirc4oafc2uddjb64l7ae";
		final String userPoolId = "us-east-1_C7Hl5ePb3";
		...
		initiateAuthRequest.addAuthParametersEntry("USERNAME", "jonasrbneto");
